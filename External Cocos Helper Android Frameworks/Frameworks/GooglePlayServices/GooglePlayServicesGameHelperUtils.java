...
class GooglePlayServicesGameHelperUtils 
{
	...
	private static int[] RES_IDS = new int[4];

	static void setResIDS(Context app)
	{
		  RES_IDS[0] = app.getResources().getIdentifier("gamehelper_unknown_error","string",app.getPackageName());
		  RES_IDS[1] = app.getResources().getIdentifier("gamehelper_sign_in_failed","string",app.getPackageName());
		  RES_IDS[2] = app.getResources().getIdentifier("gamehelper_app_misconfigured","string",app.getPackageName());
		  RES_IDS[3] = app.getResources().getIdentifier("gamehelper_license_failed","string",app.getPackageName());
	}
	...
	static String getString(Context ctx, int whichString) 
	{
		...
		{
			ex.printStackTrace();
			Log.w(GooglePlayServicesGameHelper.TAG,
